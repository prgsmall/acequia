...
function startServers() {
    ...
    oscServer.on("message", function (msg, rinfo) {
        ...
        for (i in oscMsgs) {
            ...
            default:
                ...
                message = new msg.AcequiaMessage(from, title, oscMsg.data, to);
    ...
    wsServer.sockets.on('connection', function (socket) {
        ...
        socket.on('message', function (data) {
            ...
            var m, message = new msg.AcequiaMessage(JSON.parse(data));
            ...
            case msg.MSG_DISCONNECT:
                clients.get(message.from).send(new msg.AcequiaMessage("SYS", msg.MSG_DISCONNECT, 1));
            ...
            case msg.MSG_GETCLIENTS:
                ...
                clients.get(message.from).send(new msg.AcequiaMessage("SYS", msg.MSG_GETCLIENTS, clientList));
                break;
    ...
    tcpServer = net.createServer(function (socket) {
        ...
        socket.addListener("data", function (data) {
            var index = 0, msgs = [], size, message, m, 
