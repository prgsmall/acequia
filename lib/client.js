...
AcequiaClients.prototype.createClient = function (type, message, socket, rinfo) {
    ...
    case TYP_OSC:
        ...
        client = new ac.OSCClient(message.from, rinfo.address, rinfo.port, portOut, socket);
    case TYP_TCP:
        return new TCPClient(message.from, socket.remoteAddress, socket.remotePort, socket);
    case TYP_WS:
